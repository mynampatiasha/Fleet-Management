  ...
  Future<Map<String, dynamic>> updateVehicle(
    ...
    try {
      ...
      final body = {
        ...
        'type': (updateData['vehicleType'] ?? '').toString().toUpperCase(),
        'make': updateData['make'] ?? '',
        'model': updateData['model'] ?? '',
        'year': updateData['yearOfManufacture'] ?? 0,
        'engineType': updateData['engineType'] ?? '',
        'engineCapacity': updateData['engineCapacity'] ?? 0.0,
        'seatingCapacity': updateData['seatingCapacity'] ?? 0,
        'mileage': updateData['mileage'] ?? 0.0,
        'status': (updateData['status'] ?? 'ACTIVE').toString().toUpperCase(),
      };
