...
class ApiConfig {
  ...
  static String get baseUrl {
    ...
    if (kIsWeb) {
      ...
      const mobileUrl = 'http://10.38.15.123:3001'; // ✅ FIXED PORT
  ...
  static String get wsUrl {
    ...
    if (kIsWeb) {
      ...
      _agentLog(
        'api_config.dart:wsUrl',
        'Using web websocket URL',
        {'value': webWsUrl},
        'H3',
      );
      return webWsUrl;
    } else {
      const mobileWsUrl = 'ws://10.38.15.123:3001'; // ✅ FIXED PORT
