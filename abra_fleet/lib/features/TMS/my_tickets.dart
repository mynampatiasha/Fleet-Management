...
class _MyTicketsScreenState extends State<MyTicketsScreen> with SingleTickerProviderStateMixin {
  ...
  Future<void> _checkAuthAndFetchTickets() async {
    ...
    if (userDataString != null) {
      ...
      debugPrint('✅ My Tickets: User logged in');
