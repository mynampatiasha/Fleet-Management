...
class _CustomerDashboardState extends State<CustomerDashboard> {
  ...
  void initState() {
    super.initState();
    _initializeApp();  // ← Changed from _loadUserData()
    _loadQuickStats();
  ...
  // ✅ Show notification toast with navigation
...
// ============================================================================
  // 🆕 FUNCTION 8: Show Fallback Emergency Dialog (100/112)
  // ============================================================================
  ...
  // ✅ LOAD ACTIVE TRIP ID FROM BACKEND
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        if (data['success'] && data['hasActiveTrip'] == true && data['trip'] != null) {
          ...
          debugPrint('✅ Loaded active trip ID: $_activeTripId');
        } else {
          if (mounted) {
            setState(() {
              _activeTripId = null;
          ...
          debugPrint('ℹ️ No active trips found');
        }
      }
    } catch (e) {
  ...
  void _listenForSOSHistory() async {
    ...
    // ✅ REPLACED: Firebase Database with HTTP API polling
  ...
  try {
    debugPrint('🔍 Fetching SOS history for user: $_userId');
    
    // ✅ FIXED: Use the correct endpoint with status filter and proper query params
    final response = await http.get(
    ...
    if (response.statusCode == 200) {
      ...
      for (var alert in sosData) {
        try {
          ...
          // ✅ CRITICAL FILTER: Only include resolved SOS alerts for THIS customer
      ...
      if (mounted) {
        ...
        debugPrint('✅ Loaded ${_sosHistory.length} SOS history items for this customer');
      }
    } else {
      ...
      try {
        ...
        if (response.statusCode == 200 && mounted) {
          ...
          if (currentStatus != null &&
            ...
            timer.cancel(); // Stop polling once acknowledged
  ...
  // 💬 Show Support Dialog as Overlay
  ...
  // 📧 Launch Email - WEB & MOBILE OPTIMIZED
  ...
  // ============================================================================
  // 🆕 NEW FUNCTION 1: Check if customer has an active trip
  // ============================================================================
  Future<Map<String, dynamic>?> _checkActiveTrip() async {
    try {
      if (token == null || token!.isEmpty || _userId == null) return null;

      debugPrint('🔍 Checking for active trip for user: $_userId');
  ...
  // ============================================================================
  // 🆕 NEW FUNCTION 2: Fetch complete trip details
  // ============================================================================
  ...
  // ============================================================================
  // 🔄 MODIFIED: Enhanced SOS Trigger with Trip Validation
  // ============================================================================
  Future<void> _triggerSOS() async {
    ...
    try {
      ...
      debugPrint('✅ Active trip validated. Proceeding with SOS...');
      ...
      debugPrint('📤 Sending SOS payload to backend...');
  ...
  // ============================================================================
// 🆕 FUNCTION 5: Find Nearest Police Station (OpenStreetMap - FREE)
// ============================================================================
...
// ============================================================================
// 🆕 FUNCTION 6: Show Police Call Confirmation Dialog
// ============================================================================
...
// ============================================================================
// 🆕 FUNCTION 7: Initiate Phone Call to Police
// ============================================================================
Future<void> _initiatePoliceCall(String phoneNumber, String stationName) async {
  ...
  // ============================================================================
  // 🆕 NEW FUNCTION 8: Show Nearby Police Stations from Backend Response
  // ============================================================================
  ...
  // ============================================================================
  // 🆕 NEW FUNCTION 4: Show Enhanced Success Dialog
  // ============================================================================
