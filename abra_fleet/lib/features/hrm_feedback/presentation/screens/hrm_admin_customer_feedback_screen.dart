// lib/features/hrm_feedback/presentation/screens/hrm_admin_customer_feedback_screen.dart
...
class HrmAdminCustomerFeedbackScreen extends StatefulWidget {
  const HrmAdminCustomerFeedbackScreen({super.key});

  @override
  State<HrmAdminCustomerFeedbackScreen> createState() => _HrmAdminCustomerFeedbackScreenState();
}

class _HrmAdminCustomerFeedbackScreenState extends State<HrmAdminCustomerFeedbackScreen> {
  ...
  Future<void> _loadFeedback() async {
    ...
    // Fetch ONLY customer feedback for admin HRM view
    ...
    return Container(
      ...
      child: Column(
        children: [
          ...
          Row(
            children: [
              _buildStatCard('Total', _feedbackList.length, Colors.blue),
              ...
              Row(
                children: [
                  IconButton(
                    icon: Icon(
                      Icons.grid_view,
                      color: _viewMode == 'grid' ? const Color(0xFF3b82f6) : Colors.grey,
                    ),
                  ...
                  IconButton(
                    icon: Icon(
                      Icons.list,
                      color: _viewMode == 'list' ? const Color(0xFF3b82f6) : Colors.grey,
                    ),
          ...
          child: Column(
            children: [
              ...
              Padding(
                ...
                child: Row(
                  children: [
                    const Icon(Icons.feedback, color: Color(0xFF3b82f6)),
                    const SizedBox(width: 12),
                    Expanded(
                      child: Text(
  ...
  void _showAdminReplyModal(HrmFeedbackModel feedback) {
    ...
    showDialog(
      ...
      builder: (context) => AlertDialog(
        title: Row(
          children: [
            const Icon(Icons.admin_panel_settings, color: Color(0xFF3b82f6)),
            const SizedBox(width: 12),
