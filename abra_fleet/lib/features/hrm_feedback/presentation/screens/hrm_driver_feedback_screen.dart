// lib/features/hrm_feedback/presentation/screens/hrm_driver_feedback_screen.dart
...
class HrmDriverFeedbackScreen extends StatefulWidget {
  final String? userName;
  final String? userEmail;

  const HrmDriverFeedbackScreen({
    Key? key,
    this.userName,
    this.userEmail,
  }) : super(key: key);
  ...
  @override
  State<HrmDriverFeedbackScreen> createState() => _HrmDriverFeedbackScreenState();
}

class _HrmDriverFeedbackScreenState extends State<HrmDriverFeedbackScreen> {
  ...
  Future<void> _loadFeedback() async {
    ...
    // Admin view: Get ALL driver feedback instead of user-specific feedback
    final feedback = await _feedbackService.getAllFeedback('driver');
    setState(() {
    ...
    return Container(
      ...
      child: Column(
        children: [
          ...
          Text(
            'View and manage all driver feedback submissions',
            style: TextStyle(
              fontSize: 14,
      ...
      child: Column(
        ...
        children: [
          Container(
            ...
            child: Row(
              children: [
                const Icon(Icons.edit_note, color: Color(0xFF0D47A1), size: 24),
          ...
          child: Column(
            children: [
              ...
              Padding(
                ...
                child: Row(
                  children: [
                    const Icon(Icons.chat_bubble, color: Color(0xFF0D47A1)),
                    const SizedBox(width: 12),
                    const Expanded(
                      child: Text(
          ...
          Row(
            children: [
              Icon(
                ...
                size: 16,
                color: isUser ? const Color(0xFF0D47A1) : const Color(0xFF10b981),
              ),
              const SizedBox(width: 8),
              Text(
                name,
  ...
  void _showReplyModal(HrmFeedbackModel feedback) {
    showDialog(
      ...
      builder: (context) => AlertDialog(
        title: const Row(
          children: [
            Icon(Icons.reply, color: Color(0xFF0D47A1)),
            SizedBox(width: 12),
            Text('Reply to Admin'),
          ],
        ),
