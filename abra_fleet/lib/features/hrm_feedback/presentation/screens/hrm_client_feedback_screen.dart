// lib/features/hrm_feedback/presentation/screens/hrm_client_feedback_screen.dart
...
class HrmClientFeedbackScreen extends StatefulWidget {
  final String? userName;
  final String? userEmail;

  const HrmClientFeedbackScreen({
    Key? key,
    this.userName,
    this.userEmail,
  }) : super(key: key);
  ...
  @override
  State<HrmClientFeedbackScreen> createState() => _HrmClientFeedbackScreenState();
}

class _HrmClientFeedbackScreenState extends State<HrmClientFeedbackScreen> {
  ...
  Future<void> _loadFeedback() async {
    ...
    // Client view: Get ONLY current user's feedback
    final feedback = await _feedbackService.getMyFeedback('employee');
    setState(() {
  ...
  Future<void> _submitFeedback() async {
    ...
    final result = await _feedbackService.submitEmployeeFeedback(
    ...
    return Container(
      ...
      child: Column(
        children: [
          ...
          const Text(
            'Submit feedback and view your submission history',
            style: TextStyle(
              fontSize: 14,
      ...
      child: Column(
        children: [
          Container(
            ...
            child: Row(
              children: [
                const Icon(Icons.history, color: Color(0xFF9333EA), size: 24),
                const SizedBox(width: 12),
                const Text(
                  'My Feedback History',
                  style: TextStyle(
          ...
          child: Column(
            children: [
              ...
              Padding(
                ...
                child: Row(
                  children: [
                    const Icon(Icons.chat_bubble, color: Color(0xFF9333EA)),
                    const SizedBox(width: 12),
                    const Expanded(
                      child: Text(
          ...
          Row(
            children: [
              Icon(
                ...
                size: 16,
                color: isUser ? const Color(0xFF9333EA) : const Color(0xFF10b981),
              ),
              const SizedBox(width: 8),
              Text(
                name,
  ...
  void _showReplyModal(HrmFeedbackModel feedback) {
    showDialog(
      ...
      builder: (context) => AlertDialog(
        title: const Row(
          children: [
            Icon(Icons.reply, color: Color(0xFF9333EA)),
            SizedBox(width: 12),
            Text('Reply to Admin'),
          ],
        ),
