...
class _ClientReportsAnalyticsEnhancedState extends State<ClientReportsAnalyticsEnhanced> {
  ...
  Future<void> _initializeClientData() async {
    ...
    try {
      // Get current user's organization domain from JWT token
